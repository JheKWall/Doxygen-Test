...
\hyperlink{classEmployee}{Employee} class (and children) Testing Program.  
...
\end{DoxyAuthor}
\begin{DoxyDate}{Date}
2022-\/11-\/14 Tests the \hyperlink{classEmployee}{Employee} class and its children using customized functions. 
\end{DoxyDate}
...
\hyperlink{classEmployee}{Employee} class \& children testing function


\begin{DoxyParams}{Parameters}
{\em \hyperlink{classEmployee}{Employee}} & \& e An \hyperlink{classEmployee}{Employee} (or derivative) class \\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondition}
Initialized \hyperlink{classEmployee}{Employee} (or derivative) object 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
void 
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
Tests will be conducted on the given object. 
\end{DoxyPostcond}
